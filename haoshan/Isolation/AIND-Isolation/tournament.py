...
from game_agent import aggressive_heuristic, defensive_heuristic, maximizing_win_chances_heuristic, minimizing_losing_chances_heuristic, \
                        chances_heuristic, weighted_chances_heuristic, weighted_chances_heuristic_2, \
                        point_of_view_heuristic, weight_factor_heuristic, min_max_heuristic, scoring_heuristic, \
                        offensive_to_defensive_heuristic, blocking_opponent_heuristic

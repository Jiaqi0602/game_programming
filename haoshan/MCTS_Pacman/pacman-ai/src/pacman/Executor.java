...
import pacman.entries.pacman.mcts.MonteCarloPacman;
...
//		exec.runGame(new StarterPacMan(), new Legacy2ThestaticReckoning(), visual,delay);
...
//		exec.runExperiment(new MonteCarloPacman(), new Legacy2TheReckoning(), numTrials);
...
//		System.out.println("NEAREST PILL PACMAN VISUAL vs LEGACY2THERECONING");
//		exec.runGame(new NearestPillPacManVS(), new Legacy2TheReckoning(), visual,delay);
//		
//		
...
//			System.out.println("Score: " + game.getScore() + ", Level: " + (game.getCurrentLevel()+1) + ", Time used: " + game.getTotalTime());
		}
		System.out.println("Score: " + game.getScore() + ", Level: " + (game.getCurrentLevel()+1) + ", Time used: " + game.getTotalTime());
	}

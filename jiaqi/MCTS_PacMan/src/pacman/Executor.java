...
//		int numTrials=10;
//		exec.runExperiment(new MCTS(),new RandomGhosts(),numTrials);


		int delay=15;
		boolean visual=true;
		exec.runGame(new MCTS(),new RandomGhosts(),visual,delay);
...
//		boolean visual=true;
//		exec.runGameTimed(new NearestPillPacMan(),new StarterGhosts(),visual);
...
//		exec.runGameTimedSpeedOptimised(new MCTS(),new RandomGhosts(),fixedTime,visual);

...
from game_agent import aggressive_heuristic, defensive_heuristic, maximizing_win_chances_heuristic, minimizing_losing_chances_heuristic, chances_heuristic, weighted_chances_heuristic, weighted_chances_heuristic_2, heuristic_1, heuristic_2, heuristic_3, heuristic_4, heuristic_5
...
def main():
    ...
    # submitted agent f or calibration on the performance across different
    ...
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
                   ...
                   Agent(CustomPlayer(score_fn=heuristic_1, **CUSTOM_ARGS), "LIM JIA QI - 17134267"),
                   Agent(CustomPlayer(score_fn=heuristic_2, **CUSTOM_ARGS), "WONG HAO SHAN - 17122789"),
                   Agent(CustomPlayer(score_fn=heuristic_3, **CUSTOM_ARGS), "CHEAH JO YEN - 17059391"),
                   Agent(CustomPlayer(score_fn=heuristic_4, **CUSTOM_ARGS), "CHONG SIN MEI - 17103500"),
                   Agent(CustomPlayer(score_fn=heuristic_5, **CUSTOM_ARGS), "Offensive to defensive")
                   ]
